...
async function main() {
  ...
  const classDefs: ClassSeed[] = [
    { name: "6ème A", level: "6ème", roomCode: "6A", building: "Bloc A", publicId: "rm_a1_demo", studentCount: 18 },
    { name: "5ème A", level: "5ème", roomCode: "5A", building: "Bloc A", publicId: "rm_a2_demo", studentCount: 16 },
    { name: "4ème A", level: "4ème", roomCode: "4A", building: "Bloc A", publicId: "rm_a3_demo", studentCount: 17 },
    { name: "3ème A", level: "3ème", roomCode: "3A", building: "Bloc B", publicId: "rm_a4_demo", studentCount: 20 },
    { name: "2nde B", level: "2nde", roomCode: "2B", building: "Bloc B", publicId: "rm_b5_demo", studentCount: 18 },
    { name: "1ère B", level: "1ère", roomCode: "1B", building: "Bloc C", publicId: "rm_b6_demo", studentCount: 15 },
    { name: "Terminale C", level: "Terminale", roomCode: "TC", building: "Bloc C", publicId: "rm_c7_demo", studentCount: 14 },
  ];
  ...
  const scheduleByDay: Record<(typeof WEEKDAYS)[number], Lesson[]> = {
    mon: [
      ...
      { className: "5ème A", subjectCode: "FR", teacherId: nzue.id, period: 0 },
      { className: "5ème A", subjectCode: "MATH", teacherId: obame.id, period: 2 },
      { className: "5ème A", subjectCode: "SVT", teacherId: mintsa.id, period: 3 },
      ...
      { className: "1ère B", subjectCode: "PHILO", teacherId: nzue.id, period: 2 },
      { className: "1ère B", subjectCode: "MATH", teacherId: obame.id, period: 5 },
    ...
    tue: [
      ...
      { className: "5ème A", subjectCode: "HG", teacherId: essono.id, period: 1 },
      { className: "5ème A", subjectCode: "EPS", teacherId: ndong.id, period: 2 },
      { className: "5ème A", subjectCode: "FR", teacherId: nzue.id, period: 4 },
      ...
      { className: "1ère B", subjectCode: "HG", teacherId: essono.id, period: 0 },
      { className: "1ère B", subjectCode: "PC", teacherId: mintsa.id, period: 3 },
      { className: "1ère B", subjectCode: "FR", teacherId: nzue.id, period: 5 },
    ...
    wed: [
      ...
      { className: "5ème A", subjectCode: "MATH", teacherId: obame.id, period: 0 },
      { className: "5ème A", subjectCode: "ANG", teacherId: essono.id, period: 3 },
      ...
      { className: "1ère B", subjectCode: "MATH", teacherId: obame.id, period: 2 },
      { className: "1ère B", subjectCode: "EPS", teacherId: ndong.id, period: 4 },
    ...
    thu: [
      ...
      { className: "5ème A", subjectCode: "FR", teacherId: nzue.id, period: 1 },
      { className: "5ème A", subjectCode: "PC", teacherId: mintsa.id, period: 2 },
      { className: "5ème A", subjectCode: "MATH", teacherId: obame.id, period: 4 },
      ...
      { className: "1ère B", subjectCode: "ANG", teacherId: essono.id, period: 1 },
      { className: "1ère B", subjectCode: "PHILO", teacherId: nzue.id, period: 3 },
      { className: "1ère B", subjectCode: "PC", teacherId: mintsa.id, period: 5 },
      { className: "Terminale C", subjectCode: "MATH", teacherId: obame.id, period: 2 },
    ...
    fri: [
      ...
      { className: "5ème A", subjectCode: "SVT", teacherId: mintsa.id, period: 0 },
      { className: "5ème A", subjectCode: "ANG", teacherId: essono.id, period: 1 },
      { className: "5ème A", subjectCode: "EPS", teacherId: ndong.id, period: 5 },
      ...
      { className: "1ère B", subjectCode: "FR", teacherId: nzue.id, period: 0 },
      { className: "1ère B", subjectCode: "MATH", teacherId: obame.id, period: 3 },
      { className: "1ère B", subjectCode: "SVT", teacherId: mintsa.id, period: 4 },
    ...
    sat: [
      ...
      { className: "2nde B", subjectCode: "HG", teacherId: essono.id, period: 1 },
      { className: "1ère B", subjectCode: "PHILO", teacherId: nzue.id, period: 0 },
